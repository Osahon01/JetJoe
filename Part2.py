...
c6 = M6*(gamma_T*287*T_t6)**0.5
print(f'c6 here', c6, M6)
...
c_pT = 1243.67
shaft_pow = W_Turb() #From Part 1
print("SHAFT POWER ", shaft_pow, " J/kg")
h_f = 42 * 10**6 # [J/kg]  (Kerosine)
gamma_C = 1.4
gamma_T = 1.3
...
P_t5 = P_t4*((T_t5/T_t4 - 1)/eta_T + 1)**(gamma_T/(gamma_T-1))
P_t6 = P_t5
print("Stagnation pressure at exit = ", P_t6)
M_6 = (2/(gamma_T-1)*((P_t6/P_6)**((gamma_T-1)/(gamma_T))-1))**(1/2)
a_6 = (gamma_T*R*T_6)**(1/2)
c_6 = M_6 * a_6
print("Mach number at nozzle exit = ", M_6)
print("Nozzle exit velocity = ", c_6)
# A_6 = 0.0013283844 # [m^2] measured; converted from 2.059 in^2
# A_4 = 0.001 # [m^2] measured (DUMMY VALUE TIL WE CALCULATE)
# Solve for Mach number at nozzle exit
# M_6 = symbols('M_6')
