...
P_0 = 101325 #101325 # [Pa] Atmospheric pressure at sea level
...
c6 = M6*a6
# T_t5_s = T_t5 + (c_pC*(T_t3-T_0))/(c_pT*(f+1))*(1-1/eta_T)
# c6 = (2*c_pT*T_t5*(1-(T_t4/T_t5_s)*((P_0/P_t3)**((gamma_T - 1)/gamma_T))))**0.5
...
T = m4*c6
print(f'Thrust = {T} [N], Thrust Imperial: {T / 4.4482} [lbf]')
